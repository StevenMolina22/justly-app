---
name: slice-reference
description: Reference codebase for Slice App. Use this skill when you need to understand the structure, implementation patterns, or code details of the Slice App project.
---

# Slice App Codebase Reference

91 files | 11058 lines | 90057 tokens
